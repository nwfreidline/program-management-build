"""
Build the Narrative Template for DocForge based on the user's preferred formatting.

Formatting derived from: "Narrative-Optics Feature Request-External Partner Access Portal.docx"

Key formatting characteristics:
- Page: Letter size, narrow margins (0.54" L/R, ~0.72" T/B)
- Header: "Month Year – Team – Doc title" left-aligned
- Footer: "Amazon Confidential" left + "Page X of Y" right
- Body font: Calibri 11pt, single spacing, 6pt space after paragraphs
- Heading 1: Calibri 16pt bold, 12pt space before, 0pt space after
- Heading 2: Calibri 13pt bold, 12pt space before, 0pt space after  
- Heading 3: Calibri 11pt bold, 6pt space before, 0pt space after
- List Paragraph: Calibri 11pt, 0.25" left indent, 6pt space after
- Tables: Calibri 10pt, light borders, bold header row, minimal cell padding
"""
...
def build_template():
    ...
    # Heading 1 — Main section headers (Purpose, Background, Problem, etc.)
    ...
    # AMZN H2 — Amazon-style heading (keep for compatibility)
    ...
    header_para.text = "DocForge — Narrative"
    ...
    # === PLACEHOLDER CONTENT (will be cleared by DocForge on conversion) ===
    # Add a single placeholder paragraph so the template isn't empty
    p = doc.add_paragraph("", style="Normal")
    
    # === SAVE ===
    output_path = "templates/docx/Narrative_Template.docx"
    doc.save(output_path)
    print(f"Template saved to: {output_path}")
    
    # Also save a copy at the root templates dir for backward compat
    doc.save("templates/Narrative_Template.docx")
    print("Also saved to: templates/Narrative_Template.docx")
